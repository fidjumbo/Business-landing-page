        ...
        <div className='bg-blue-600 rounded-2xl overflow-hidden'>
            <div className='relative md:px-16 py-16 px-6 md:py-24'>
               ...
               <div className='relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12'>
                {/* left content */}
                <div className='text-white mx-w-lg text-center md:text-left'>
                    <h2 className='text-2xl sm:text-3xl lg:text-4xl font-medium mb-4'>Subscribe newsletter</h2>
                    <p className='text-blue-100 sm:text-base text-sm'>Best cooks and best delivery guys all at your 
                    service. Hot tasty food</p>
                </div>
                ...
                <div className='flex flex-col sm:flex-row gap-4 sm:gap-0'>
                    ...
                    px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-l-none flex sm:rounded-r-lg items-center gap-2'>
                        <span>Discover</span>
