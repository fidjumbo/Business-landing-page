...
const PurposeSection = () => {
  ...
  return (
    <section className='w-full bg-gray-100 py-16 px-4 md:px-8 sm:px-6' id='about'>
        <div className='max-w-6xl mx-auto'>
          <div className='grid md:grid-cols-3 grid-cols-1 gap-8'>

            {/* heading text */}
          <div className=''>
            <p className='text-sm text-purple-600 font-medium mb-2'>ARCHIVE MORE</p>
            <h2 className='text-3xl md:w-4/5 w-full md:text-4xl font-bold
            text-gray-900'>Purpose of a convoy is to keep your team</h2>
          </div>
