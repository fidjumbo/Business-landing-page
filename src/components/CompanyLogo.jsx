...
const CompanyLogo = () => {
  ...
  return (
    ...
    sm:items-center items-start'>
        <div className='w-[300px] shrink-0 px-6 text-gray-600 border-l-4 
        border-blue-500 bg-white py-2 z-10 sm:text-base
        text-xl font-semibold text-left'>Proud partner at <br /> Hubsot & Segment</div>
