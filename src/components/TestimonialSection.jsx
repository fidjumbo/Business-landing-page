      ...
      >
        {
          testimonials.map((testimonial, index) => (
              ...
              <div className='text-center bg-white p-4 rounded-lg shadow-md h-full flex flex-col'>
                ...
                <div className='flex justify-center mb-2'>
                  {[...Array(5)].map((_, starIndex) => (
                     <span className='text-yellow-400'><MdOutlineStarPurple500 /></span>
                  ))}
                </div>
                <h3 className='text-xl font-semibold mv-3'>{testimonial.name}</h3>
            ...
            <div className='flex justify-center gap-4 md:mt-8 mt-4'>
              ...
              hover:bg-blue-500 hover:text-white transition-all border-gray-200 duration-200 cursor-pointer border'>
