    ...
    <section className='py-20 container mx-auto px-4 sm:px-6 lg:px-8' id='services'>
       <div className='flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24'>
        ...
        <div className='md:w-1/3 w-full'>
            ...
            <p className='text=gray-600 text-lg mb-4 md:w-4/5'>Discuss your goals, determine success metrics, 
            identify problems</p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            {
                services.map((service, index) => (
                    <div key={index} className='bg-white max-w-72 cursor-pointer rounded-2xl
                    p-6 hover:shadow-xl transition-all hover:scale-105 duration-300'>
